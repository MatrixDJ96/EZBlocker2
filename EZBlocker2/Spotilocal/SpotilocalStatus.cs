namespace EZBlocker2
{
    internal class SpotilocalStatus
    {
        ...
        private Track track;
        private OpenGraphState open_graph_state;

        public SpotilocalStatus(string message) => error = new Error(message);

        public string Playing { get => playing; set => playing = value; }
        public string Next_enabled { get => next_enabled; set => next_enabled = value; }
